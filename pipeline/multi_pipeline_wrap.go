...
func (m *multiPipelineWrap) Process(ctx context.Context, namespace, spiderName string, data interface{}) error {
	...
	for i := range m.pipes {
		...
		handlers = append(handlers, func() error {
			...
			err := pipe.Process(pipeCtx, namespace, spiderName, data)
			if err != nil {
